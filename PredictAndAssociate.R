##Script runs a loop to run all tissues and phenotypes in PrediXcan from an input list through prediction and association, creating folders of the tissues with folders of the phenotypes within them
